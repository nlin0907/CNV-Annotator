...
python $DIR/calls_txt_to_bed.py $SDIR/calls.txt $SDIR/calls.bed
...
python $DIR/gff_parsing.py $DIR/DGV.GS.March2016.50percent.GainLossSep.Final.hg19.gff3 $DIR/DGVHG37.bed 
sort-bed $DIR/DGVHG37.bed > $DIR/sorted_DGVHG37.bed
...
bedmap --echo --echo-map-id-uniq --fraction-both 0.75 $SDIR/anno_calls3.bed $DIR/sorted_DGVHG37.bed > $SDIR/annotated_calls.bed
...
python $DIR/final_step.py $SDIR/combined.txt $SDIR/sorted_sampleID_calls.bed $SDIR/FINAL_ANNOTATED_CALLS.txt
